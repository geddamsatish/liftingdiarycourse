...
## ⚠️ CRITICAL: ALWAYS Reference docs/* Before Code Generation

**All code generated by Claude Code MUST FIRST refer to the relevant documentation in `docs/*.md`** before writing or modifying ANY code. This is a hard requirement.

**EVERY task MUST follow this workflow:**
1. **Read** the relevant `docs/*.md` file(s) for specifications
2. **Understand** the authoritative requirements and patterns
3. **Generate** code that strictly adheres to those specifications

**Do not skip this step** — the docs contain binding specifications for:

- UI/UX design patterns and component guidelines (shadcn/ui components ONLY, no custom components)
- Feature requirements and behavior expectations
- Data models and API contracts  
- Styling conventions, color systems, and design tokens
